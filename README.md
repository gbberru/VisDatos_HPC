...
4. Seleccionar las columnas relevantes para consumo energético, temperatura, uso de recursos y jobs SLURM.
...
7. Convertir unidades técnicas a formatos interpretables: bytes a GB, miliwatts a watts, joules a kWh y segundos a horas.
8. Generar un dataset final reducido y enriquecido en formato Parquet.
9. Preparar archivos agregados para mejorar el rendimiento del dashboard.
...
1. `Transform_data/Transform_data.ipynb`
2. `Transform_data/Revison_data.ipynb`
3. `Transform_data/Prepare_dashboard_data.ipynb`
4. `Transform_data/Visual_tests.ipynb` *(opcional, usado para pruebas de visualización)*
